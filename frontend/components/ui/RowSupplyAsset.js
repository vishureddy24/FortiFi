    ...
    <>
      <tr>
        ...
        <td className="border-t-0 px-4 border align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
          <div className="text-base font-medium text-gray-800">{todp(token.walletBalance ? token.walletBalance.amount : 0, 4)}</div>
          <div className="text-sm text-gray-500">${todp(token.walletBalance ? token.walletBalance.inDollars : 0, 2)}</div>
        </td>
        <td className="border-t-0 px-4 border  align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
