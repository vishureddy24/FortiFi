                          ...
                          <div className="w-full px-2">
                            <div className="relative flex sm:flex-row sm:mt-0 mt-6 flex-col xl:w-5/12 min-w-0 p-3 rounded mb-6 xl:mb-0 ">
                              <div className="flex items-center">
                                ...
                                <div className="">
                                    {network.data === "Ganache"
                                    ?<div className="text-2xl sm:text-2xl text- ml-2 text-white font-bold">Ethereum Ganache Market</div>
                                    :  (<><div className="bg-red-500 p-2 text-sm rounded-md text-white">Connected to the Wrong network</div>
                                    <div className="text-2xl sm:text-2xl text- ml-2 text-white font-bold">Switch to Ganache</div></>)
                                    }
                                </div>
                              </div>
